          ...
          <header>
            <nav class="navbar">
              ...
              <div class="nav-social">
                ...
                <img src={logoTwitter} class="mr-2" alt="Twitter" />
              </div>
              <div class="bx mr-3"></div>
            </nav>
          </header>

          <section class="bg-video">
            <video class="video" preload="none" autoplay muted loop>
          ...
          <section class="container">
            <div class="container-item-1">
              ...
              <p class="my-2 item-2">
                ...
                velit magna vitae mauris orci fames posuere nibh. Sit tellus
                amet facilisi sit odio pulvinar scelerisque quam et. Ultrices
                facilisis nunc massa diam, quis mi imperdiet.
              </p>
              <p class="mt-1 flex item-3">
                <span>
              ...
              <p class="mt-2 flex align-items-center item-4">
                <img
                  src={logoPlaystation}
                  class="w-auto"
